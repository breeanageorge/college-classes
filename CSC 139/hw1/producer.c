...
void InitShm(int bufSize, int itemCnt)
{
    int in = 0;
    int out = 0;
	const char *name = "OS_HW1_BreeanaGeorge"; // Name of shared memory object to be passed to shm_open
...
void Producer(int bufSize, int itemCnt, int randSeed)
{
    ...
    // Write code here to produce itemCnt integer values in the range [0-1000]
